...
So wie es hier steht rettet uns kein Syntax Fehler der Shell, der SSH läuft ja fehlerfrei.
...
* Puppet ist eine der ersten Sprachen
...
* Ansible ist eine imperative Sprache
